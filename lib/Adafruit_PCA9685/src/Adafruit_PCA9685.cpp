/***************************************************
  ...
  https://github.com/grovelabs/Spark-Adafruit-PCA9685/tree/master/firmware
 ****************************************************/
 ...
 */
PCA9685::PCA9685(uint8_t addr, bool debug) {
  _i2caddr = addr;
  _debug = debug;
}
 ...
 * frequency has to be smaller than 1520 Hz
...
void PCA9685::setPWMFreq(float freq) {
  ...
  delay(1);
  write8(PCA9685_MODE1, oldmode | 0xa1);  // Turns on auto increment in PCA9685_MODE1 register
}
 ...
 */
void PCA9685::setVal(uint8_t ledNum, uint16_t val, bool invert)
{
 ...
 */
uint16_t PCA9685::readPWMOff(uint8_t ledNum) {
 ...
 */
uint16_t PCA9685::readPWMOn(uint8_t ledNum) {
 ...
 */
void PCA9685::setPWM(uint8_t ledNum, uint16_t on, uint16_t off) {
  if (_debug) {
