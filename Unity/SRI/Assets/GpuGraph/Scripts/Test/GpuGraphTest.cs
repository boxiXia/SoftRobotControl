...
public class GpuGraphTest : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GraphManager.Graph.Plot("Test_WorldSpace", currentDeltaTime, Color.black, new GraphManager.Matrix4x4Wrapper(transform.position, transform.rotation, transform.localScale));
